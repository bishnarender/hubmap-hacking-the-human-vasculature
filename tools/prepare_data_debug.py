...
annotations = load_annotations('data_debug/polygons.jsonl') 
df = pd.read_csv('data_debug/tile_meta.csv')
# df.head() =>
...
mmengine.dump(df2coco(trainval, annotations), f'data_debug/dtrainval.json')
...
mmengine.dump(df2coco(train0[:2], annotations), f'data_debug/dtrain0i.json') # [:2] my_
mmengine.dump(df2coco(val0[:4], annotations), f'data_debug/dval0i.json') # [:2] my_
...
mmengine.dump(df2coco(train1, annotations), f'data_debug/dtrain1i.json')
mmengine.dump(df2coco(val1, annotations), f'data_debug/dval1i.json')

df3 = df.query('(dataset == 2)')
mmengine.dump(df2coco(df3, annotations), 'data_debug/dtrain_dataset2.json')
