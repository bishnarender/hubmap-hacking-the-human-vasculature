...
#                                              scale=1.)
        ...
        # scale => 1.5
#         if np.random.uniform(0, 1) < self.scale_prob: # commenting this will not drop the bounding boxes.
...
#         M4[1, 2] += margin_h * np.random.uniform(0, 1)
    ...
    def transform(self, results):
        ...
        M = self._get_affine_matrix(results['img']) # comment my_
        #M = results['img']
